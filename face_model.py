...
# from Face_Recongition_Edge.mtcnn_detector import MtcnnDetector
# from Face_Recongition_Edge import face_preprocess
...
class FaceModel:
  ...
  def get_feature(self, aligned):
    ...
    # self.model.forward(db, is_train=True)
  ...
  def get_ga(self, aligned):
    ...
    # self.ga_model.forward(db, is_train=True)
